...
Pour 10 000 élements :

| Tri par sélection     | Tri rapide | Tri standard  |
| :-------------------: |:----------:|:-------------:|
|  **159.082ms**   |   **3.993ms**   |   **2.6534ms**  |

Même si nous parlons ici de ms, on peut dire que :
- le tri rapide est bien rapide et est assez optimisé pour de grands tableaux puisqu'il fait un premier tri grâce au pivot.
- le tri par sélection est bien plus long puisqu'il doit parcourir répétitivement le tableau de 500 élements ou plus et est inutilisable pour des tableaux trop grands. C'est là qu'on constate vraiement sa complexité en O(n²) et qu'on comprend qu'une complexité en O(nlog(n)) est plus rapide.
